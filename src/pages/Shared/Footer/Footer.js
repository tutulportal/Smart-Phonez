...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-primary text-base-content">
            ...
            <div>
                <p className='text-white'>Copyright © 2022 - All right reserved designed by, MD Shariful Islam Tutul</p>
            </div>
        </footer>
    );
};
